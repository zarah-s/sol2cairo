...
fn detokenize(input: &Token) -> String {
    match input {
        ...
        Token::Seconds => "seconds".to_string(),
        Token::Minutes => "minutes".to_string(),
        Token::Hours => "hours".to_string(),
        Token::Days => "days".to_string(),
        Token::Weeks => "weeks".to_string(),
        Token::Years => "years".to_string(),
        Token::Wei => "gwei".to_string(),
        Token::Gwei => "gwei".to_string(),
        Token::Szabo => "szabo".to_string(),
        Token::Finney => "finney".to_string(),
